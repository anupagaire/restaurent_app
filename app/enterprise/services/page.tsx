...
export default async function EnterpriseServicesPage() {
  const headersList = await headers();
  const restaurantId = Number(headersList.get('x-restaurant-id') ?? '8'); // fallback jasto About page ma thyo
      ...
      <>
        ...
        <div className="sv-empty">
          <div className="sv-empty__card">
            ...
            <Link href="/" className="sv-empty__link">← Back to Home</Link>
          </div>
        </div>
      </>
    );
      ...
      <div className="sv">
        ...
        <header className="sv-hero">
          ...
          <div className="sv-hero__left">
            <Link href="/" className="sv-hero__back">
        ...
        <main className="bg-[#fdf9f4]">
          ...
          {/* ── FEATURE CARDS ── */}
          <section className="sv-feat max-w-7xl">
          ...
          {services.content && (
            <section className="sv-content bg-background">
          ...
          <section className="sv-why bg-[#fdf9f4]">
            <div className="sv-why__head">
              <div className="sv-why__label">Why Us</div>
              <h2 className="sv-why__title text-black">Why Choose Our Services</h2>
          ...
          {/* ── CTA ── */}
          <section className="sv-cta bg-accent">
            <div className="sv-cta__inner">
              <p className="sv-cta__sub">Ready to experience our services yourself?</p>
              <div className="sv-cta__btns">
                <Link href="/menu" className="sv-cta__btn sv-cta__btn--primary">
                  Reserve a Table
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              ...
              <Link href="/" className="sv-cta__back">← Back to Home</Link>
            </div>
          </section>
...
.sv-feat__title, .sv-why__title, .sv-gallery__title {
  ...
  font-weight:700; margin:0 0 16px; line-height:1.1;
}
...
/* ── Feature cards ── */
.sv-feat {
   margin:0 auto; padding:80px 48px 60px;
}
...
/* ── CTA ── */
.sv-cta {  padding:80px 48px; }
.sv-cta__inner { max-width:600px; margin:0 auto;color:black; text-align:center; }
