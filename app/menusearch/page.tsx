...
function MenuSearchContent() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf8f3]">
      {/* Header */}
      <div className="bg-gradient-to-br from-[#2a1505] via-[#3d1a08] to-[#1a0b02] py-10 px-6 text-center">
        <p className="text-amber-200/60 text-xs font-medium uppercase tracking-widest mb-2">Menu Finder</p>
        <h1 className="text-white text-2xl sm:text-3xl font-bold mb-1">
          Compare Dishes Across Restaurants
        </h1>
        <p className="text-amber-200/60 text-sm">Ranked by rating · Filter by price</p>
      </div>
