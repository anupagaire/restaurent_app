...
export default function SuperAdminDashboard() {
  return (
    <div className="space-y-8">
      <div>
        <h2 className="text-3xl font-bold text-gray-900">Welcome back, Super Admin</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium text-gray-500">Active Admins</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-medium text-gray-500">Total Orders Today</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-gray-500 text-sm">Activity log will be shown here</p>
          </CardContent>
        </Card>
      </div>
    </div>
