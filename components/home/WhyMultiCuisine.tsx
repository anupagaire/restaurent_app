...
export default function WhyMultiCuisine() {
  ...
  return (
    <>
      {/* COMMITMENT SECTION */}
      <section className="relative bg-[#011659] text-white overflow-hidden">
        <div className="relative z-10 flex flex-col lg:grid lg:grid-cols-2 min-h-screen">

          {/* LEFT — Text column */}
          <div className="flex flex-col justify-center px-6 sm:px-10 md:px-14 lg:px-20 py-8 w-full min-w-0">
            ...
            >
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-[1.1] tracking-tight text-white break-words">
                {c.title}
              </h2>
              <h2
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-light leading-[1.1] tracking-tight italic break-words"
                style={{ color: '#d4b78f' }}
              >
                {c.highlight_text}
              </h2>
            ...
            <motion.div
              ...
              className="text-sm sm:text-base lg:text-lg text-white/60 font-light leading-relaxed mb-10 ql-content break-words overflow-hidden"
            ...
            >
              ...
              <div className="space-y-0 border-t border-white/10">
                {c.experience_points.map((item, i) => (
                  <div
                    key={i}
                    className="group flex items-start sm:items-center gap-4 sm:gap-6 py-4 border-b border-white/10 hover:border-[#d4b78f]/40 transition-colors duration-300"
                  >
            ...
            <div className="sticky top-0 h-screen w-full overflow-hidden">
              <div className="absolute inset-0">
                <Image
                  ...
                  priority
                />
                <div className="absolute inset-0 bg-gradient-to-r from-[#011659] via-[#011659]/20 to-transparent" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#011659]/60 via-transparent to-transparent" />
              </div>
              ...
              <div className="absolute bottom-10 right-6 flex flex-col gap-3 z-10">
                {[1, 2, 3].map((idx) => (
                  <motion.div
                    ...
                    className="relative w-32 h-24 overflow-hidden rounded-sm border border-white/20 hover:border-[#d4b78f]/60 transition-all duration-500 hover:scale-105"
                  >
                    <Image
